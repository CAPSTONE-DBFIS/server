...
public class ChatbotApiController {
    ...
    @Operation(summary = "사용자 입력을 Flask 서버로 전송하고 결과를 받아 반환하고 비동기적으로 DB에 저장", description = "사용자 입력을 Flask 서버로 전송하고 결과를 받아 즉시 응답을 반환하고 비동기적으로 RDB에 저장합니다.")
    public ResponseEntity<?> handleUserQuery(
        ...
        requestBody.put("session_id", chatroomId);
